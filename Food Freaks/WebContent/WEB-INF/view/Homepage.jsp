...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
      ...
      <ul class="nav navbar-nav">
		...
		<li><a href="down.html">Download App</a></li>
    ...
    <section id="intro" class="intro">
		...
		<div class="slogan">
			...
			<h4>WE ARE HERE TO PROVIDE YOU DETAILS ABOUT THE BEST FOOD IN THE CITY</h4>
		</div>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-4 col-md-4">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
						<h5>Nishant Goyal</h5>
                        <p class="subtitle">Spring DAO Manager</p>
                        <div class="avatar"><img src="Designing/FrontDesign/img/team/1.jpg" alt="" class="img-responsive img-circle" /></div>
                    </div>
                </div>
				</div>
            </div>
			<div class="col-xs-6 col-sm-4 col-md-4">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
						<h5>Shubham Jain</h5>
                        <p class="subtitle">Spring Web Module and Designing</p>
                        <div class="avatar"><img src="Designing/FrontDesign/img/team/2.jpg" alt="" class="img-responsive img-circle" /></div>
			...
			<div class="col-xs-6 col-sm-4 col-md-4">
                ...
                <div class="team boxed-grey">
                    <div class="inner">
						<h5>Anmol Purohit</h5>
                        <p class="subtitle">Spring View Module</p>
                        <div class="avatar"><img src="Designing/FrontDesign/img/team/3.jpg" alt="" class="img-responsive img-circle" /></div>
