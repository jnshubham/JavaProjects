		...
		<div class="heading-about">
			...
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<h2>New Useer Registration</h2>
					<i class="fa fa-2x fa-angle-down"></i>

<form:form action="saveuser.html" method="POST">
...
<tr>
    ...
    <td><form:input path="userid" id="userid" readonly="true" value="${autogen}" class="form-control"/></td>
</tr>
<tr>
...
<tr>
    ...
    <td><form:input path="dob" id="dob" class="form-control"/></td>
     <td><span id="msgdob"></span></td>
</tr>
<tr>
    <td><form:label path="emailid">Email ID :</form:label></td>
    <td><form:input path="emailid" id="emailid" class="form-control"/></td>
...
<tr>
    ...
    <td><form:input path="picture" id="picture" type="file" class="form-control"/></td>
...
<tr>
    ...
    <td><form:input path="cpassword" id="cpassword" class="form-control"/></td>
