...
$(function () {
 ...
 $("#cart").click(function () {
	...
	<link href="Designing/iframe.css" rel="stylesheet" type="text/css">
    <!-- Fonts -->
	...
	<tbody>	
		<c:forEach items="${m}" var="c">
			<tr>
				...
				<td><a href=openDishes.html?menuid=${c.menuid} target="ifr"><c:out value="${c.menuname}"/></a><br>
				<c:out value="${c.description}"/></td>
			</tr>
		</c:forEach>
	</tbody>		
	</table>
...
<center>
<input type="button" value="Proceed to Cart" id="cart" class="btn btn-primary" />
</center>
</div>
					</div>
				</div>
